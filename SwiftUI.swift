...
public struct Alert {
    ...
    ///   - primaryButton: The first button to show in the alert.
    ///   - secondaryButton: The second button to show in the alert.
    /// - Returns: a side-by-side button alert.
...
/// A `TabViewStyle` that implements the carousel `TabView` interaction and
/// appearance.
@available(watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
...
/// A gauge view that visually indicates its value using an open ring which
/// has an visual indicator as the value increases, displaying the
/// `currentValueLabel` the center of the gauge.
///
/// If provided `minimumValueLabel` and `maximumValueLabel` are placed in the
/// opening at the bottom of the ring. Otherwise `label` is placed in the
/// opening of the ring.
@available(watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
...
/// the user.
///
/// Apple Watch Series 3 does not support ``EllipticalListStyle`` and will instead
/// use ``PlainListStyle``.
@available(watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
...
extension EnvironmentValues {
    ...
    /// An action which requests the focus system to re-evaluate default focus.
...
/// ``CircularGaugeStyle`` to the view:
///
///     struct LabeledGauge: View {
///         @State private var current = 67.0
///         @State private var minValue = 0.0
...
public struct Gauge<Label, CurrentValueLabel, BoundsLabel, MarkedValueLabels> : View where Label : View, CurrentValueLabel : View, BoundsLabel : View, MarkedValueLabels : View {
    ...
    /// ``CircularGaugeStyle`` shows its current value of `67` along with a
...
/// hierarchy.
///
/// To configure the current ``GaugeStyle`` for a view hierarchy, use the
/// ``View/gaugeStyle(_:)`` modifier.
@available(watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
@available(tvOS, unavailable)
...
/// A gauge view that visually indicates its value using a bar which has an
/// continuous visual indicator as the value increases.
///
/// If provided `minimumValueLabel` and `maximumValueLabel` are displayed on
/// either side of the gauge. Otherwise `currentValueLabel` is displayed on the
/// leading edge.
@available(watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
...
public struct LinearGaugeStyle : GaugeStyle {
    ...
    /// Construct a linear gauge.
    public init()

    /// Construct a linear gauge that draws with a Color.
    public init(tint: Color)

    /// Construct a linear gauge that draws with a gradient.
    public init(tint: Gradient)
    ...
    ///
    /// - Parameter configuration: The properties to apply to the gauge instance.
    public func makeBody(configuration: LinearGaugeStyle.Configuration) -> some View
...
extension NavigationLink where Destination == _WKStoryboardContent {
    ...
    /// Creates a navigation link that presents a view from a WatchKit
    /// storyboard.
    /// - Parameters:
    ///   - destinationName: The storyboard name of a view for the navigation
    ///    link to present.
    ///   - label: A view builder to produce a label describing the
    ///   `destination` to present.
    @available(iOS, unavailable)
    ...
    /// Creates a navigation link that presents a view from a WatchKit
    /// storyboard when a bound selection variable matches a value you
    /// provide.
    /// - Parameters:
    ///   - destinationName: The storyboard name of a view for the navigation
    ///    link to present.
...
/// Provides functionality for manipulation of the currently focused view.
@available(tvOS 14.0, watchOS 7.0, *)
@available(iOS, unavailable)
@available(macOS, unavailable)
public struct ResetFocusAction {

    /// Asks the focus sytem to re-evaluate the default focus item.
    ///
    /// Focus is re-evaluated when the currenty focused item is within the
    /// given namespace.
    ///
    /// - Parameter namespace: Namespace for which focus should be reset. The
    /// namespace should match the focusScope block where focus needs to be reset.
...
extension View {
    ...
    ///
    /// Use ``View/listRowPlatterColor(_:)`` to set the underlying row
    ...
    /// background color to the ``Color`` you specify.
    ///
    ///     struct ContentView: View {
    ///         enum Flavor: String, CaseIterable, Identifiable {
    ///             var id: String { self.rawValue }
    ...
    ///     }
    ///
    /// - Parameter color: The ``Color`` to apply to the system cell.
    ///
    /// - Returns: A view with the specified `color` applied to the system cell.
    @available(iOS, unavailable)
    @available(macOS, unavailable)
...
extension View {
    ...
    ///   on Apple Watch.](SwiftUI-View-digitalCrownRotationBindingFull.png)
    ///   
    /// - Parameters:
    ///   - binding: A binding to a value that updates when the user rotates
    ///     the  Digital Crown.
    ...
    ///   - sensitivity: How much the user needs to rotate the  Digital Crown
    ...
    ///   - isHapticFeedbackEnabled: Controls the generation of haptic feedback
    ...
    ///
    /// ![A screenshot showing a value received by turning the Digital Crown
    ///   on Apple Watch.](SwiftUI-View-digitalCrownRotationBinding.png)
    ///
    /// - Parameter binding: A binding to a value that updates as the user
...
extension View {
    ...
    /// Sets whether `self` prefers to be focused by default for a namespace.
    ///
    /// This modifier sets initial focus preference when nothing else is focused.
    /// Default focus preference is limited to the ancestor with focusScope that
    /// matches the namespace provided in this modifier.
    /// If multiple views express this preference, then the current platform
    /// rules for determining default focus will be used to choose from among
    /// them.
    ///
    /// - Parameters:
    ///   - prefersDefaultFocus: prefersDefaultFocus: A Boolean value that
    ///   indicates whether this view prefers to be focused by default.
    ///   - namespace: The namespace associated with the focusScope within which
    ///   this view prefers default focus
    /// - Returns: A view that sets whether it prefers to be focused by default.
    public func prefersDefaultFocus(_ prefersDefaultFocus: Bool = true, in namespace: Namespace.ID) -> some View


    /// Creates a focus scope that can be used to limit default focus preferences
    ///
    /// The returned view gets associated with the provided namespace.
    /// This namespace can be passed to prefersDefaultFocus and to ResetFocus.
    ///
    /// - Parameter namespace: A Namespace ID that is used to scope
    ///   default focus preferences
    /// - Returns: A view that sets namespace of descendants for default focus
...
extension View {
    ...
    ///
    ///
    /// ![A screenshot showing the effect changing the height of picker wheel
    /// items on watchOS.](SwiftUI-View-defaultWheelPickerItemHeight.png)
    ///
    /// - Parameter height: The height for the picker items.
    @available(iOS, unavailable)
    @available(macOS, unavailable)
    @available(tvOS, unavailable)
...
extension View {
    ...
    /// and Mission Control.
    ///
    /// - Parameter title: The view to display.
    @available(iOS, unavailable)
    @available(macOS, unavailable)
    @available(tvOS, unavailable)
    public func navigationTitle<V>(@ViewBuilder _ title: () -> V) -> some View where V : View
...
extension View {
    ...
    ///
    /// In this example, the `TextField` is configured for the entry of email
    /// addresses.
    ///
    ...
    ///   <doc://com.apple.documentation/documentation/UIKit/UITextContentType> enumeration
    ///   that identify the semantic meaning expected for a text-entry area.
    ///   These include support for email addresses, location names, URLs, and
    ///   telephone numbers, to name just a few.
    @available(watchOS 6.0, *)
    @available(iOS, unavailable)
    @available(macOS, unavailable)
    @available(tvOS, unavailable)
...
@available(macOS, unavailable)
@available(tvOS, unavailable)
@propertyWrapper public struct WKExtensionDelegateAdaptor<DelegateType> : DynamicProperty where DelegateType : NSObject, DelegateType : WKExtensionDelegate {

    /// The underlying delegate.
    public var wrappedValue: DelegateType { get }

    /// Creates an `WKExtensionDelegateAdaptor` using a WatchKit Extension
    /// Delegate.
    ///
    ...
    /// own work.
    ///
    /// - Parameter delegate: the type of `WKExtensionDelegate` to use.
...
///
/// A ``WKHostingController`` presents and manages your app's main interface
/// using SwiftUI views. You must subclass ``WKHostingController`` and override
/// the ``WKHostingController/body`` property to provide the set of SwiftUI
...
open class WKHostingController<Body> : WKInterfaceController where Body : View {
    ...
    /// controller.
    ///
    /// Override this property and return the root view of your SwiftUI view
    /// hierarchy from your implementation. If you don't override this property,
    /// accessing the default implementation triggers an exception.
    ...
    /// an updated set of views from its ``WKHostingController/body`` property.
    ...
    /// ``WKHostingController/setNeedsBodyUpdate()``.
...
/// to create and update the interface object.
///
...
/// provide a ``NSViewControllerRepresentable/Coordinator`` instance to
...
public protocol WKInterfaceObjectRepresentable : View where Self.Body == Never {
    ...
    ///
    /// You must implement this method and use it to create your interface
    /// object. Configure the object using your app's current data and contents
    /// of the `context` parameter. The system calls this method only once, when
    /// it creates your interface object for the first time. For all subsequent
    /// updates, the system calls the
    /// ``WKInterfaceObjectRepresentable/updateWKInterfaceObject(_:context:)``
    /// method.
    ///
    /// - Parameter context: A context structure containing information about
    ///   the current state of the system.
    ///
    /// - Returns: Your interface object configured with the provided
    ///   information.
    ...
    /// custom interface object. For example, you might use this method to
    /// remove observers or update other parts of your SwiftUI interface.
    ///
    /// - Parameters:
    ///   - wkInterfaceObject: Your custom interface object.
    ...
    ///
    /// Implement this method if changes to your interface object might affect
    ...
    /// SwiftUI properties, causing the two to remain synchronized. If your
    /// interface object doesn't interact with other parts of your app,
    /// providing a coordinator is unnecessary.
    ///
    /// SwiftUI calls this method before calling the
    /// ``WKInterfaceObjectRepresentable/makeWKInterfaceObject(context:)``
    /// method. The system provides your coordinator either directly or as part
...
extension WKInterfaceObjectRepresentable {
    ...
    /// Cleans up the presented interface object (and coordinator) in
...
///
/// A ``WKInterfaceObjectRepresentableContext`` structure contains details about
...
/// appropriate method of your custom ``WKInterfaceObjectRepresentable``
...
public struct WKInterfaceObjectRepresentableContext<Representable> where Representable : WKInterfaceObjectRepresentable {
    ...
    ///
    /// Use the environment values to configure the state of your interface
    /// object when creating or updating it.
...
@available(macOS, unavailable)
@available(tvOS, unavailable)
public struct WKNotificationScene<Content, Controller> : Scene where Content : View, Controller : WKUserNotificationHostingController<Content> {

    /// Creates a scene that appears in response to receiving a specific
    /// category of remote or local notifications.
    ///
    /// Use a watch notification instance to add support for one or more
    /// Apple Watch notification scenes that appear on receipt of the local or
    /// remote notification categories you specify. The example below, adds two
    /// notification scenes to the app declaration:
    ///
    ///     @main
    ...
    /// ``WKUserNotificationHostingController`` and a category string that you
    /// provide. The hosting controller displays your notification's content
    /// view upon receipt of a local or a
    /// <doc://com.apple.documentation/documentation/PushKit> notification.
    /// The category string you specify corresponds to the category name in
    /// the notification's dictionary and describes a specific notification
    /// that contains the content displayed by the notification view.
    ///
    /// - Parameters:
    ///   - controller: The type of ``WKUserNotificationHostingController`` to
    ///     display upon receipt of the specified notification category.
    ///   - category: The category of notifications to listen for.
    public init(controller: Controller.Type = Controller.self, category: String)
...
/// ``WKUserNotificationHostingController`` and override the
/// ``WKUserNotificationHostingController/body`` property to provide the set of
...
open class WKUserNotificationHostingController<Body> : WKUserNotificationInterfaceController where Body : View {
    ...
    @available(watchOS 7.0, *)
    open class var isInteractive: Bool { get }
    ...
    @available(watchOS 7.0, *)
    open class var sashColor: Color? { get }

    /// If the sash should include a blur over the background.
    ///
    /// Default value is `false`
    @available(watchOS 7.0, *)
    open class var wantsSashBlur: Bool { get }
    ...
    /// Default value is `nil`
    @available(watchOS 7.0, *)
    open class var titleColor: Color? { get }
    ...
    /// Default value is `nil`
    @available(watchOS 7.0, *)
    open class var subtitleColor: Color? { get }
    ...
    /// Default value is `nil`
    @available(watchOS 7.0, *)
    open class var coalescedDescriptionFormat: String? { get }
